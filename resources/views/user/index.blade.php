            ...
            <main class="flex-1 p-4">
                <div class="flex flex-col lg:flex-row gap-4 mb-6">
                    <div class="flex-1 bg-indigo-100 border border-indigo-200 rounded-xl p-6 animate-fade-in">
                        ...
                        <span class="inline-block mt-8 px-8 py-2 rounded-full text-xl font-bold text-white bg-indigo-800 uppercase">
                            {{ Auth::user()->role }}
                        </span>
                    </div>
                    ...
                    <div class="flex-1 bg-blue-100 border border-blue-200 rounded-xl p-6 animate-fade-in">
                        ...
                        <a href="#last-row" onclick="document.getElementById('last-row').scrollIntoView({ behavior: 'smooth' }); return false;"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <button data-modal-target="transfer-modal" data-modal-toggle="transfer-modal"type="button">
                        <div class="bg-white rounded-xl shadow-lg p-6 h-20 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl animate-slide-up flex items-center gap-3" style="animation-delay: 0.3s">
                                <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M274-120 80-314l194.67-194.67 47 46.67L207-347.33h633v66.66H207l114 114L274-120Zm412-331.33L639-498l114-114H120v-66.67h633L638.33-793.33l47-46.67L880-645.33l-194 194Z"/></svg>
            ...
            <table class="w-full  id="last-row">
                <thead>
                    <tr class="bg-blue-300">
                        ...
                        <th class="w-1/4 py-4 px-6 text-left text-gray-600 font-bold uppercase">Jumlah</th>
                ...
                <tbody class="bg-blue-100">
                    ...
                    <tr>
                        <td class="py-4 px-6 border-b border-gray-200">{{ $item->created_at->format(' d M Y H:i') }}</td>
                        <td class="py-4 px-6 border-b border-gray-200">{{ $item->sender_id->name }}</td>
                        ...
                        <td class="py-4 px-6 border-b border-gray-200">
                            <span class="{{ $item->confirmed == 0 ? 'bg-red-500' : 'bg-green-500' }} text-white py-1 px-2 rounded-full text-xs">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="{{ route('user.transfer') }}" method="POST">
                        @csrf
                        <label for="receiver" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih Siswa Penerima:</label>
                        <select name="receiver_id" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
