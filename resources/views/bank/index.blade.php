        ...
        <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div class="flex h-16 items-center justify-between">
            <div class="md:flex md:items-center md:gap-6">
              <a class="block text-teal-600" href="user.html">
                ...
                <div class="flex flex-col lg:flex-row gap-4 mb-6">
                    <div class="flex-1 bg-indigo-100 border border-indigo-200 rounded-xl p-6 animate-fade-in">
                        <h2 class="text-4xl md:text-5xl text-blue-900">
                            Welcome <br><strong class="capitalize">{{ Auth::user()->name }}</strong>
                        </h2>
                    ...
                    <div class="flex-1 bg-blue-100 border border-blue-200 rounded-xl p-6 animate-fade-in overflow-y-auto h-64 ">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="py-4 flex gap-3 justify-center">
                                        <span class="bg-red-500 text-white py-1 px-2 rounded-full text-xs">
                                            <form action="{{ route('bank.destroy', ['bank'=>$item->id]) }}" method="POST" onsubmit="return confirm('apakah anda ingin menghapus akun ini?');">
                                                @csrf
                                                @method('DELETE')
                                            <button type="submit"> 
                    ...
                    <button data-modal-target="tambah-modal" data-modal-toggle="tambah-modal" type="button">
                        <div class="bg-white rounded-xl shadow-lg p-6 h-20 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl animate-slide-up flex items-center gap-3" style="animation-delay: 0.1s">
                            <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#1f1f1f"><path d="M440-280h80v-160h160v-80H520v-160h-80v160H280v80h160v160Zm40 200q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>
                                <h3 class="text-xl font-bold text-indigo-800 ">ADD USER</h3>
                        </div>
                    </button>
            ...
            <table class="w-full " id="last-row">
                ...
                <tbody class="bg-blue-100">
                    ...
                    <tr>
                        ...
                        <td class="py-4 px-6 border-b border-gray-200">{{ $item->senders->name }}</td>
                ...
                <form class="space-y-4" action="{{ route('bank.topup') }}" method="POST">
                    ...
                    <div>
                        <label for="user_id"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Masukkan
                            User</label>
                        <select name="user_id" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
    ...
    <div id="tariktunai-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="{{ route('bank.tariktunai') }}" method="POST">
                        @csrf
                        <div>
                            <label for="amount"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Masukkan
